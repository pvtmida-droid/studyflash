...
const ADMIN_CARD_CATEGORIES = [
  ...
  },
  {
    ...
    subfolders: [
      ...
      { id: "Art & Culture", nameEn: "GS/GK > Art & Culture (कला एवं संस्कृति)", nameHi: "सामान्य अध्ययन > कला एवं संस्कृति", subject: "Art & Culture", topic: "Culture", examTags: ["Art & Culture", "Culture"] },
